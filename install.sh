...
for _Version in `ls com/ctrip/framework/xpipe/`; do
	mvn install:install-file -Dfile=com/ctrip/framework/xpipe/$_Version/xpipe-parent-$_Version.pom -DpomFile=com/ctrip/framework/xpipe/$_Version/xpipe-parent-$_Version.pom -Dpackaging=pom -DgroupId=com.ctrip.framework.xpipe -DartifactId=xpipe-parent -Dversion=$_Version
done
...
for _Version in `ls ctripgroup/scm/enforcer-custom-rules/`; do
	mvn install:install-file -Dfile=ctripgroup/scm/enforcer-custom-rules/$_Version/enforcer-custom-rules-$_Version.pom -DpomFile=ctripgroup/scm/enforcer-custom-rules/$_Version/enforcer-custom-rules-$_Version.pom -Dpackaging=pom -DgroupId=ctripgroup.scm.enforcer-custom-rules -DartifactId=enforcer-custom-rules -Dversion=$_Version
done
