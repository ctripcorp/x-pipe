...
public class DefaultEndPoint implements Endpoint, Serializable {
    ...
    @JsonIgnore
    private ProxyConnectProtocol protocol = null;
    ...
    public DefaultEndPoint(String ip, int port, ProxyConnectProtocol protocol) {
        this(ip, port);
        this.protocol = protocol;
    }

    public DefaultEndPoint(InetSocketAddress address, ProxyConnectProtocol protocol) {
        this(address);
        this.protocol = protocol;
    }
    ...
    public String toString() {
        if (protocol != null) {
            return String.format("endpoint: %s, proxy info: %s", rawUrl, protocol);
        }
        return rawUrl;
    }
