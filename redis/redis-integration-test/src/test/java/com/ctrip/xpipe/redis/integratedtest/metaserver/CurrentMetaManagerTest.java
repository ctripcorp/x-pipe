...
@Component
public class CurrentMetaManagerTest extends AbstractLifecycleObservable implements CurrentMetaManager, Observer {
    ...
    public CurrentMetaManagerTest(CurrentClusterServer currentClusterServer) {
    ...
    public void setPeerMaster(String dcId, String clusterId, String shardId, long gid, String ip, int port, RedisProxy proxy) {
        ...
        RedisProxyMeta peerMaster = (RedisProxyMeta)new RedisProxyMeta().setProxy(proxy).setIp(ip).setPort(port).setGid(gid);
        currentMeta.setPeerMaster(dcId, clusterId, shardId, peerMaster);
        notifyPeerMasterChange(dcId, clusterId, shardId);
    }

    @Override
    public RedisProxyMeta getPeerMaster(String dcId, String clusterId, String shardId) {
    ...
    public List<RedisProxyMeta> getAllPeerMasters(String clusterId, String shardId) {
