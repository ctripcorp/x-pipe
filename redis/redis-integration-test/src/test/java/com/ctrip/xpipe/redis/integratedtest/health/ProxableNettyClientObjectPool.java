 ...
 * Jul 29, 2018
 */
public class ProxableNettyClientObjectPool extends AbstractLifecycle
    ...
    public ProxableNettyClientObjectPool(List<ProxyEndpoint> tcpProxies) {
        this(createDefaultConfig(GenericKeyedObjectPoolConfig.DEFAULT_MAX_TOTAL_PER_KEY));
        this.tcpProxies = tcpProxies;
    }

    public ProxableNettyClientObjectPool(int maxPerKey) {
    ...
    public ProxableNettyClientObjectPool(GenericKeyedObjectPoolConfig config) {
        this.config = config;
    ...
    protected void doInitialize() throws Exception {
        ...
        this.pooledObjectFactory = new ProxableNettyClientFactory(tcpProxies);
