...
insert into CLUSTER_TBL (id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_designated_route_ids, cluster_last_modified_time, logical_bu_id) values(1, 'cluster1', 1, 'cluster1 desc', 1, '1,2', 20170426180546610, 42);
