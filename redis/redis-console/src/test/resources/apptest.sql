insert into CLUSTER_TBL(id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_type, cluster_last_modified_time) values(5, 'singleDcCluster', 1, 'Cluster:singleDcCluster , ActiveDC : A', 1,'SINGLE_DC', 20170426180546606);
insert into CLUSTER_TBL(id, cluster_name, activedc_id, cluster_org_id, cluster_type, cluster_last_modified_time) values(6,'credis_trocks_test',0, 1,'CROSS_DC', 20170426180546607);
...
insert into CLUSTER_TBL (id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_last_modified_time) values (2, 'cluster2', 1, 'cluster2 desc', 2, 20170426180546611);
...
insert into CLUSTER_TBL (id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_last_modified_time) values (3, 'cluster3', 2, 'cluster desc3', 3, 20170426180546612);
...
insert into CLUSTER_TBL (id, cluster_name, cluster_description, cluster_org_id, cluster_type, cluster_designated_route_ids, cluster_last_modified_time) values (4, 'bi-cluster1', 'bi-cluster1 desc', 4, 'BI_DIRECTION', '1,2', 20170426180546616);
...
-- fra-ali DC (Region FRA, LOCAL_FRA az group, keeper replication peer of fra)
insert into DC_TBL (id, zone_id, dc_name, dc_active, dc_description, dc_last_modified_time) values (4, 2, 'fra-ali', 1, 'DC:ALI-FRA', '0000000000000000');
insert into AZ_GROUP_MAPPING_TBL (id, az_id, az_group_id) values (6, 4, 2);
insert into SETINEL_TBL (setinel_id, dc_id, setinel_address, setinel_description) values (5, 4, '127.0.0.1:42222,127.0.0.1:42223', 'setinel fra-ali');
insert into SENTINEL_TBL (sentinel_id, dc_id, sentinel_group_id, sentinel_ip, sentinel_port) values (15, 4, 3, '127.0.0.1', 42222);
insert into SENTINEL_TBL (sentinel_id, dc_id, sentinel_group_id, sentinel_ip, sentinel_port) values (16, 4, 3, '127.0.0.1', 42223);
...
-- hetero cluster: ONE_WAY + SINGLE_DC (hetero-cluster)
insert into CLUSTER_TBL(id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_type, cluster_admin_emails, cluster_last_modified_time) values (12, 'hetero-cluster', 1, 'hetero cluster1 desc', 1, 'HETERO', 'test@111.com', 20170426180546626);
...
insert into CLUSTER_TBL(id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_type, cluster_admin_emails, cluster_last_modified_time) values (13, 'fra-single-dc', 3, 'fra single dc cluster', 1, 'SINGLE_DC', 'test@111.com', 20170426180546630);
...
-- hetero cluster: dual ONE_WAY (hetero-dual-oneway)
...
insert into DC_CLUSTER_TBL(dc_cluster_id, dc_id, cluster_id, az_group_cluster_id) values (52, 4, 14, 24);
...
insert into DC_CLUSTER_SHARD_TBL (dc_cluster_shard_id,dc_cluster_id,shard_id,setinel_id,dc_cluster_shard_phase) values (80,52,39,5,1);
...
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id, keeper_active) values(151,'gggggggggggggggggggggggggggggggggggggggg',77,'127.0.1.14',5200,'keeper',0,0,17,1);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(152,'unknown',77,'10.0.0.13',6379,'redis',1,0,null);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id, keeper_active) values(157,'hhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh',80,'127.0.1.20',5200,'keeper',0,0,20,1);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(158,'unknown',80,'10.0.0.16',6379,'redis',0,0,null);

-- hetero cluster: dual SINGLE_DC (hetero-dual-single-dc)
insert into CLUSTER_TBL(id, cluster_name, activedc_id, cluster_description, cluster_org_id, cluster_type, cluster_admin_emails, cluster_last_modified_time)
values (15, 'hetero-dual-single-dc', 1, 'hetero dual single dc', 1, 'HETERO', 'test@111.com', 20170426180546627);
insert into AZ_GROUP_CLUSTER_TBL(id, cluster_id, az_group_id, active_az_id, az_group_cluster_type) values(25, 15, 1, 1, 'SINGLE_DC');
insert into AZ_GROUP_CLUSTER_TBL(id, cluster_id, az_group_id, active_az_id, az_group_cluster_type) values(26, 15, 2, 3, 'SINGLE_DC');
insert into SHARD_TBL(id, shard_name, setinel_monitor_name, cluster_id, az_group_cluster_id) values(40, 'hetero-dual-single-dc_jq_1','hetero-dual-single-dc_jq_1', 15, 25);
insert into SHARD_TBL(id, shard_name, setinel_monitor_name, cluster_id, az_group_cluster_id) values(41, 'hetero-dual-single-dc_fra_1','hetero-dual-single-dc_fra_1', 15, 26);
insert into DC_CLUSTER_TBL(dc_cluster_id, dc_id, cluster_id, az_group_cluster_id) values (50, 1, 15, 25);
insert into DC_CLUSTER_TBL(dc_cluster_id, dc_id, cluster_id, az_group_cluster_id) values (51, 3, 15, 26);
insert into DC_CLUSTER_SHARD_TBL (dc_cluster_shard_id,dc_cluster_id,shard_id,setinel_id,dc_cluster_shard_phase) values (78,50,40,1,1);
insert into DC_CLUSTER_SHARD_TBL (dc_cluster_shard_id,dc_cluster_id,shard_id,setinel_id,dc_cluster_shard_phase) values (79,51,41,3,1);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(153,'unknown',78,'10.0.0.14',6379,'redis',1,0,null);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(154,'unknown',78,'10.0.0.14',6479,'redis',0,0,null);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(155,'unknown',79,'10.0.0.15',6379,'redis',1,0,null);
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id) values(156,'unknown',79,'10.0.0.15',6479,'redis',0,0,null);
...
-- ids 100-111: avoid clash with fra-ali KC 20/21 (and demo 1-6 / apptesttest 7-11,17-19)
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (100,1,'127.0.10.1',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (101,1,'127.0.10.2',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (102,1,'127.0.10.3',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (103,1,'127.0.10.4',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (104,1,'127.0.10.5',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (105,1,'127.0.10.6',8080,1,1,'DEFAULT',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (106,1,'127.0.10.7',8080,1,1,'TFS_1',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (107,1,'127.0.10.8',8080,1,1,'TFS_1',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (108,1,'127.0.10.9',8080,1,1,'TFS_1',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (109,1,'127.0.10.10',8080,1,1,'TFS_1',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (110,1,'127.0.10.11',8080,1,1,'TFS_1',42);
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,keepercontainer_org_id,keepercontainer_disk_type,logical_bu_id) values (111,1,'127.0.10.12',8080,1,1,'TFS_1',42);
