...
insert into KEEPERCONTAINER_TBL(keepercontainer_id,keepercontainer_dc,keepercontainer_ip,keepercontainer_port,keepercontainer_active,az_id, keepercontainer_org_id) values (30,3,'127.1.1.2',7033,1,1,0);
...
insert into REDIS_TBL (id,run_id,dc_cluster_shard_id,redis_ip,redis_port,redis_role,master,redis_master,keepercontainer_id, deleted) values(22,'bee',9,'127.1.1.2',7101,'keeper',0,-1,30, 0);
