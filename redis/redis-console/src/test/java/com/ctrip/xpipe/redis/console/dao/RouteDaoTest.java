...
public class RouteDaoTest extends AbstractConsoleIntegrationTest {
    ...
    public void beforeRouteDaoTest() {
        ...
        proto1 = new RouteTbl().setRouteOrgId(4L).setClusterType("").setActive(true).setDstDcId(2L).setIsPublic(true).setDescription("desc")
                .setDstProxyIds("1,2").setOptionalProxyIds("").setSrcDcId(1L).setSrcProxyIds("3,4").setTag(Route.TAG_META);
        proto2 = new RouteTbl().setRouteOrgId(3L).setClusterType("").setActive(false).setDstDcId(2L).setIsPublic(false).setDescription("test false")
        ...
        RouteTbl proto3 = new RouteTbl().setRouteOrgId(3L).setClusterType("").setActive(false).setDstDcId(2L).setDeleted(1).setDescription("")
                .setDstProxyIds("1,2").setOptionalProxyIds("").setSrcDcId(1L).setSrcProxyIds("3,4").setTag(Route.TAG_CONSOLE);
