 ...
 * Oct 08, 2018
 */
public class DiskLessReplCheckActionTest extends AbstractRedisTest {
    ...
    @Before
    public void beforeDiskLessReplCheckActionTest() {
        info = "# Server\n" +
                "redis_version:4.0.8\n" +
        ...
        when(instance.getRedisSession()).thenReturn(session);
