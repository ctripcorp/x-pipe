...
public class DefaultShardMigrationResultTest extends AbstractConsoleTest {
    ...
    @Test
    public void testCommonsPair(){

        Pair<String, String> of = Pair.of("key", "value");

        logger.info("{}", Codec.DEFAULT.encode(of));
