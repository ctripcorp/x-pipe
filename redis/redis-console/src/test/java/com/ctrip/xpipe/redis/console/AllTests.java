...
import com.ctrip.xpipe.redis.console.notifier.*;
...
@SuiteClasses(value = {
        ...
        DcClusterShardServiceImplBatchUpdateOperatingUntilTest.class,
        DcClusterShardServiceImplInsertBatchTest.class,
        DcClusterShardServiceImplTest.class,
       ...
       ClusterTypeUpdateEventListenerTest.class,
        ...
        AbstractKeeperCommandTest.class,
        CheckerKeeperActiveCommandTest.class,
