...
public class ClusterServiceImplTest extends AbstractServiceImplTest{
    ...
    public void testUpdateHeteroCluster() {
        ...
        clusterService.updateCluster(heteroClusterName, deleteOyFraModel);
        ...
        clusterService.updateCluster(heteroClusterName, addOyFraModel);
        ...
        clusterService.updateCluster(heteroClusterName, deleteShardModel);
        ...
        clusterService.updateCluster(heteroClusterName, addShard);
        ...
        try {
            clusterService.updateCluster(heteroClusterName, deleteActiveDc);
        } catch (Exception e) {
            Assert.assertEquals("can not delete active dc", e.getMessage());
        }
