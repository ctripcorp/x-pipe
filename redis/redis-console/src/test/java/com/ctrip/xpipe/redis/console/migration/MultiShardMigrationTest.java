...
public class MultiShardMigrationTest extends AbstractMigrationTest {
	...
	public void prepare() {
		...
		migrationCluster = new DefaultMigrationCluster(executors, scheduled, migrationEvent, migrationClusterTbl, null, null, null, dcService, clusterService, shardService, redisService, migrationService);
