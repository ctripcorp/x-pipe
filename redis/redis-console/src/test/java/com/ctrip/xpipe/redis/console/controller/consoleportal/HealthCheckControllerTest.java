...
public class HealthCheckControllerTest extends AbstractConsoleIntegrationTest {
    ...
    public void testGetHickwallAddress() {
        ...
        int port = 6379;
        Map<String, String> map = controller.getHickwallAddress(cluster, shard, redisIp, port,"default");
        Assert.assertEquals(map.get("addr"), "http://hickwall.qa.nt.ctripcorp.com/grafanav2/d/UR32kfjWz/fx-xpipe?fullscreen&orgId=1&from=now-1h&to=now&panelId=2&var-cluster=xpipe_function&var-shard=shard1&var-address=10.2.55.174:6379&var-delayType=default");
    }
