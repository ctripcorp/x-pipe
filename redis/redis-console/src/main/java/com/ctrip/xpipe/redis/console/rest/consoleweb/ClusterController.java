...
import com.ctrip.xpipe.redis.console.util.Paginator;
...
public class ClusterController {
	...
	public List<ClusterTbl> findClusters(@RequestParam(defaultValue = "1") int page,
    	...
    	Paginator pg = new Paginator(size);
    	pg.setPage(page);
    	pg.setItems(clusterService.getAllCount().intValue());
    	
		List<ClusterTbl> result =  clusterService.findClustersBatch(pg.getOffset(), pg.getLength());
		return result;
	}
