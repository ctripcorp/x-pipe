...
public class MetaInfoService {
	...
	public List<String> getAllDcIds() throws DalException{
		List<DcTbl> dcs = dcTblDao.findAllDcs(DcTblEntity.READSET_FULL);
		List<String> dcIds = new ArrayList<String>(dcs.size());
	...
	public List<String> getAllClusterIds() throws DalException {
		List<ClusterTbl> clusters = clusterTblDao.findAllClusters(ClusterTblEntity.READSET_FULL);
		List<String> clusterIds = new ArrayList<String>(clusters.size());
	...
	public List<String> getAllClusterShardIds(String clusterId) throws DalException {
		List<ShardTbl> shards = shardTblDao.findAllByClusterId(
				clusterTblDao.findClusterByClusterName(clusterId, ClusterTblEntity.READSET_FULL).getId(),
				ShardTblEntity.READSET_FULL);
		List<String> clusterShardIds = new ArrayList<String>(shards.size());
