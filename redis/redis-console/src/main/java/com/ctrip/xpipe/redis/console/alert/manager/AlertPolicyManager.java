...
import com.ctrip.xpipe.redis.console.alert.policy.receiver.DefaultEmailReceiver;
import com.ctrip.xpipe.redis.console.alert.policy.receiver.EmailReceiver;
...
public class AlertPolicyManager {
    ...
    public Pair<List<String>, List<String>> queryEmailReceivers(AlertEntity alert) {
