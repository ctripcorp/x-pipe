...
public class DefaultCheckMigrationCommandBuilder extends AbstractService implements CheckMigrationCommandBuilder {
    ...
    public class CheckMetaServerCommand extends AbstractCheckMigrationSystemCommand<List<String>> {
        ...
        protected List<String> getResponse() throws Exception {
            ...
            List<String> targetMetaServers = Lists.newArrayList();
            ...
            List<String> result = Lists.newArrayListWithExpectedSize(targetMetaServers.size());
            for(String metaServerAddress : targetMetaServers) {
                ...
                try {
                    ...
                    logger.error("[CheckMetaServerCommand]", e);
        ...
        @Override
        protected RetMessage validate(List<String> response) throws Exception {
            if(response.size() == metaServerAddresses.size()) {
                RetMessage.createSuccessMessage();
            }
            List<String> problemMetaServers = Lists.newArrayList(metaServerAddresses.values());
