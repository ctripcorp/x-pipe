 ...
 */
@Component
public class DelayPingActionCollector {

    private static final Logger logger = LoggerFactory.getLogger(DelayPingActionCollector.class);
    ...
    private HealthStatus createOrGetHealthStatus(RedisHealthCheckInstance instance) {
    ...
    @Component
    private class PingActionListener implements HealthCheckActionListener<PingActionContext> {
    ...
    @Component
    private class DelayActionListener implements HealthCheckActionListener<DelayActionContext> {
