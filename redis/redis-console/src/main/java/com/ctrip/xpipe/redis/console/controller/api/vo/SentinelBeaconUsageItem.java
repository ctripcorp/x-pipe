...
public class SentinelBeaconUsageItem {
    ...
    public SentinelBeaconUsageItem() {
    }

    public SentinelBeaconUsageItem(BeaconSystem beaconSystem, BeaconRouteType routeType, long orgId,
                                    MonitorService service, int clusterCount, int shardCount,
                                    List<ClusterShardInfo> clusters) {
        this.system = beaconSystem.getSystemName();
        this.beaconMode = routeType.name();
        this.orgId = orgId;
