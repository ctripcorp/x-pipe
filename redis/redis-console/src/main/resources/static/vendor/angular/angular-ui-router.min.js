        ...
        var p = function () {
            ...
            return a.prototype._set = function (a, b) {
                ...
                if (this.enabled(i.TRANSITION)) {
                    ...
                    console.logger("Transition #" + b + " Digest #" + c + ": Started  -> " + d)
                }
            }, a.prototype.traceTransitionIgnored = function (a) {
                if (this.enabled(i.TRANSITION)) {
                    var b = a.$id, c = this.approximateDigests, d = g(a);
                    console.logger("Transition #" + b + " Digest #" + c + ": Ignored  <> " + d)
                }
                ...
                if (this.enabled(i.HOOK)) {
                    ...
                    console.logger("Transition #" + c + " Digest #" + d + ":   Hook -> " + f + " context: " + g + ", " + j.maxLength(200, h))
                }
            }, a.prototype.traceHookResult = function (a, b, c) {
                if (this.enabled(i.HOOK)) {
                    var d = j.parse("transition.$id")(c), e = this.approximateDigests, f = g(a), h = g(b);
                    console.logger("Transition #" + d + " Digest #" + e + ":   <- Hook returned: " + j.maxLength(200, f) + ", transition result: " + j.maxLength(200, h))
                }
                ...
                if (this.enabled(i.RESOLVE)) {
                    ...
                    console.logger("Transition #" + c + " Digest #" + d + ":         Resolving " + e + " (" + f + ")")
                }
                ...
                if (this.enabled(i.RESOLVE)) {
                    ...
                    console.logger("Transition #" + c + " Digest #" + d + ":               <- Resolved  " + e + " to: " + j.maxLength(200, f))
                }
                ...
                if (this.enabled(i.INVOKE)) {
                    ...
                    console.logger("Transition #" + f + " Digest #" + g + ":         Invoke " + d.when + ": context: " + h + " " + j.maxLength(200, k))
                }
            }, a.prototype.traceError = function (a, b) {
                if (this.enabled(i.TRANSITION)) {
                    var c = b.$id, d = this.approximateDigests, e = g(b);
                    console.logger("Transition #" + c + " Digest #" + d + ": <- Rejected " + e + ", reason: " + a)
                }
            }, a.prototype.traceSuccess = function (a, b) {
                if (this.enabled(i.TRANSITION)) {
                    var c = b.$id, d = this.approximateDigests, e = a.name, f = g(b);
                    console.logger("Transition #" + c + " Digest #" + d + ": <- Success  " + f + ", final state: " + e)
                }
            }, a.prototype.traceUiViewEvent = function (a, b, c) {
                void 0 === c && (c = ""), this.enabled(i.UIVIEW) && console.logger("ui-view: " + j.padString(30, a) + " " + n(b) + c)
                ...
                this.enabled(i.VIEWCONFIG) && console.logger("$view.ViewConfig: " + a + " " + o(b))
            }, a.prototype.traceViewServiceUiViewEvent = function (a, b) {
                this.enabled(i.VIEWCONFIG) && console.logger("$view.ViewConfig: " + a + " " + n(b))
            }, a
        }(), q = new p;
        ...
        var d = c(3), e = c(6), f = c(4), g = c(28), h = c(12), i = new g.RejectFactory, j = {
            ...
            return a.prototype.handleHookResult = function (a) {
                ...
                for (var g = [], h = 0; h < b.length; h++)try {
                    ...
                    if (!e)throw i;
                    console.logger("Swallowed exception during synchronous hook handler: " + i)
                }
        ...
        var g = function () {
            function a() {
                this._defaultErrorHandler = function (a) {
                    a instanceof Error && console.logger(a)
                }, this._reinit()
            }
