...
public abstract class Decorator {
    ...
    protected VelocityContext generateCommonContext() {
        ...
        context.put("environment", alertConfig.getXpipeRuntimeEnvironment());
        context.put("xpipeAdminEmails", alertConfig.getXPipeAdminEmails());
        context.put("localIpAddr", foundationService.getLocalIp());
        context.put("dateTimeUtils", dateTimeUtils);
        context.put("xpipeurl", alertConfig.getConsoleDomain());
        return context;
    }
