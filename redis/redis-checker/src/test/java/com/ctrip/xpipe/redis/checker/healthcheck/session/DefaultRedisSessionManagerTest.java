...
public class DefaultRedisSessionManagerTest {
    ...
    public void getInUseRedises() {
        Set<HostPort> useRedises = sessionManager.getInUseRedises();
        Assert.assertEquals(10, useRedises.size());
    ...
    private ClusterMeta mockClusterMeta(String cluster) {
        ...
        if (cluster.equalsIgnoreCase(mockClusters.get(0))) {
            ...
            shard1.addRedis(new RedisMeta().setIp(redisIps.get(0)).setPort(6379));
            ...
            shard2.addRedis(new RedisMeta().setIp(redisIps.get(3)).setPort(6379));
            ...
            shard3.addRedis(new RedisMeta().setIp(redisIps.get(4)).setPort(6379));
            ...
            shard4.addRedis(new RedisMeta().setIp(redisIps.get(6)).setPort(6379));
