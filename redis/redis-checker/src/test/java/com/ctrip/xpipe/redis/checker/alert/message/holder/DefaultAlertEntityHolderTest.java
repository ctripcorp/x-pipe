...
public class DefaultAlertEntityHolderTest extends AbstractTest {
    ...
    private AlertEntity alertEntity() {
        return new AlertEntity(localHostport(AbstractTest.randomPort()), AbstractTest.randomString(),
                AbstractTest.randomString(), AbstractTest.randomString(), AbstractTest.randomString(), type);
    }
