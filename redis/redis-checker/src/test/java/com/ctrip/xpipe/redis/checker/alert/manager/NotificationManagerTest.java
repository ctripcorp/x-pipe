...
import com.ctrip.xpipe.redis.checker.alert.message.subscriber.AlertEntityImmediateSubscriber;
import com.ctrip.xpipe.redis.checker.alert.message.subscriber.AlertRecoverySubscriber;
import com.ctrip.xpipe.redis.checker.alert.message.subscriber.RepeatAlertEntitySubscriber;
 ...
 * Oct 19, 2017
 */
public class NotificationManagerTest extends AbstractCheckerIntegrationTest {
