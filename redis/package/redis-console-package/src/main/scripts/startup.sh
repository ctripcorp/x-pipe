...
then
    ...
    META_SPACE=512
    MAX_META_SPACE=512
    JAVA_OPTS="$JAVA_OPTS -Xms18g -Xmx18g  -XX:+AlwaysPreTouch -Xmn15g -XX:SurvivorRatio=5 -XX:MaxDirectMemorySize=${MAX_DIRECT}g -XX:MetaspaceSize=${META_SPACE}m -XX:MaxMetaspaceSize=${MAX_META_SPACE}m"
