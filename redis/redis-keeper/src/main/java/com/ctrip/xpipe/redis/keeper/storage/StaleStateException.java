...
// (e.g. a path was deleted out-of-band or a CREATE_NEW path already exists). Callers should
// rebuild their view (reopen, recompute offsets/args) and retry; plain retry on the same operation
// will not recover.
