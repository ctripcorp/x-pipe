...
public class RedisOpCrdtMSetTransferTest {
    ...
    public void transformCrdtRedisOpTest() {
        RedisOpCrdtMSetTransfer redisOpCrdtMSetTransfer = new RedisOpCrdtMSetTransfer();
        ...
        Pair<RedisOpType, byte[][]> redisOpTypePair = redisOpCrdtMSetTransfer.transformCrdtRedisOp(RedisOpType.CRDT_SET, args);
