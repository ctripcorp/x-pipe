...
public enum META_SERVER_SERVICE {
    ...
    SIDS_CHANGE(PATH.PATH_SIDS_CHANGE, ForwardType.FORWARD);
    ...
    public static class PATH extends AbstractController {
        ...
        //multi dc
        public static final String PATH_UPSTREAM_CHANGE = "/upstreamchange/" + DC_NAME_PATH_VARIABLE + "/" + CLUSTER_ID_PATH_VARIABLE + "/" + SHARD_ID_PATH_VARIABLE + "/{ip}/{port}";
        ...
        public static final String PATH_SIDS_CHANGE = "/sidschange/" + CLUSTER_ID_PATH_VARIABLE + "/" + SHARD_ID_PATH_VARIABLE + "/{sids}";
