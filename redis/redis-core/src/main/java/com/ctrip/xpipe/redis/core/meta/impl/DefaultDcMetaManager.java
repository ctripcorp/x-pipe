...
public final class DefaultDcMetaManager implements DcMetaManager{
	...
	@Override
	public RouteMeta chooseRoute(ClusterMeta cluster, String dstDc, RouteChooseStrategy strategy) {
		return metaManager.chooseMetaRoute(cluster, currentDc, dstDc, strategy);
	}
