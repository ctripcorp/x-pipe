 ...
 */
public class RedisOpCrdtHDelTransfer implements RedisOpCrdtTransfer {

    private static RedisOpCrdtHDelTransfer instance = new RedisOpCrdtHDelTransfer();

    public static RedisOpCrdtHDelTransfer getInstance() {
        return instance;
    }
