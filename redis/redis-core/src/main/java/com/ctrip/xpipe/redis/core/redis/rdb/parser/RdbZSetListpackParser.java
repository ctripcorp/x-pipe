 ...
 */
public class RdbZSetListpackParser extends AbstractRdbParser<Map<byte[], byte[]>> implements RdbParser<Map<byte[], byte[]>> {
    ...
    public RdbZSetListpackParser(RdbParseContext parseContext) {
