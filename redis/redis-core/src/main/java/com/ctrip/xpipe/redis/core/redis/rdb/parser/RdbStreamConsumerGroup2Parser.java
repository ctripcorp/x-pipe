...
/**
 * @author TB
 * @date 2026/3/20 17:39
 */

public class RdbStreamConsumerGroup2Parser extends AbstractRdbParser<byte[]> implements RdbParser<byte[]> {
    ...
    private RdbLength entriesRead; // v2新增
    ...
    private static final Logger logger = LoggerFactory.getLogger(RdbStreamConsumerGroup2Parser.class);
    ...
    public RdbStreamConsumerGroup2Parser(RdbParseContext parseContext) {
